...
public:
    ...
    void generateSubMatrix(double ** probMatrix, float ** subMatrixPseudoCounts, double ** subMatrix, int size, bool containsX, double bitFactor = 1.0, double scoringBias = 0.0);
