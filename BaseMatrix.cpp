...
void BaseMatrix::initMatrixMemory(int alphabetSize) {
    ...
    subMatrix = new double*[alphabetSize];
    ...
    for (int i = 0; i < alphabetSize; i++){
        ...
        subMatrix[i] = new double[alphabetSize];
...
void BaseMatrix::generateSubMatrix(double ** probMatrix, float ** subMatrixPseudoCounts, double ** subMatrix, int size, bool containsX, double bitFactor, double scoringBias){
